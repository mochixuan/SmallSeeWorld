...
public class SharedPreUtils {
	...
	public static void setComSharePref(Context context,String key,String value){
		SharedPreferences sp=context.getSharedPreferences(SharedPreUtils.CONFIG, context.MODE_PRIVATE);
		key=EncryptionUtils.setEncryptionMD5(key);
		sp.edit().putString(key, value).commit();
	}
	
	public static String getComSharePref(Context context,String key,String defValue){
		SharedPreferences sp=context.getSharedPreferences(SharedPreUtils.CONFIG, context.MODE_PRIVATE);
		key=EncryptionUtils.setEncryptionMD5(key);
		String value = sp.getString(key, defValue);
		return value;
